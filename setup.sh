...
#    /usr/local/bin/xdebugsetup 
    ...
    if [ ! -d "/var/www/html/d7-ck/sites/default/files" ]; then
        mkdir /var/www/html/d7-ck/sites/default/files
        chown -R apache:vagrant /var/www/html/d7-ck/sites/default/files
    fi
    
    cp /vagrant/data/config_files/settings.php              /var/www/html/d7-ck/sites/default/
    cp /vagrant/data/config_files/htaccess                  /var/www/html/d7-ck/.htaccess
    chown -R apache:vagrant /var/www/html/d7-ck
