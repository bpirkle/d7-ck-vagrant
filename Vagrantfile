...
Vagrant.configure("2") do |config|
  ...
  config.vm.network :forwarded_port, guest: 80, host: 8788
  config.vm.network :forwarded_port, guest: 3306, host: 8789
  config.vm.network :forwarded_port, guest: 8983, host: 8790
  config.vm.network :forwarded_port, guest: 9090, host: 8791
  config.vm.network :forwarded_port, guest: 443, host: 8742  
  config.vm.network :forwarded_port, guest: 8443, host: 8743  
  ...
  config.vm.synced_folder "../d7-ck/", "/mnt/d7-ck"
